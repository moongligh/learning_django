...
urlpatterns = [
    ...
    # question_views.py
    path('qusetion/create/', question_views.question_create, name='question_create'),
    ...
    path('comment/delete/qusetion/<int:comment_id>/', comment_views.comment_delete_question, name='comment_delete_question'),
